...
function Header() {
    ...
    const NavLink = ({ href, children, isMobile = false })=>{
        ...
        const linkClasses = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])('transition-colors hover:text-accent focus:text-accent', isActive ? 'text-accent font-semibold' : 'text-foreground/80', isMobile ? 'text-lg p-4' : 'text-sm font-medium');
...
_s(Header, "EzO3iiOxwczOKZ2VP7lwiwWCp7g=", false, function() {
    return [
...
//# sourceMappingURL=src_2038ee8b._.js.map